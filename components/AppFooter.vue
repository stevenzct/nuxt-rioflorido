<template>
  <div>
    ...
    <!--instagram  -->
          ...
          <!-- subheadline -->
          <h6
            class="text-white font-neue-montreal text-[18px] font-normal leading-[138%] w-auto lg:w-96 py-4"
          >
            Committed to Your Success, We Strive to Engineer Solutions Tailored
            Exclusively for You
          </h6>
        </div>
