      ...
      >
        ...
        <div class="w-full">
          ...
          >
            ...
            >
              Five (5) Bedroom Two (2) Storey Residential House with 408 sqm
              total floor area. (Rances Residence)
            </p>
...
<style scoped>
#hero-section {
  background-image: url("../assets/images/all-images/buildings/Lucena, Rances Residence/Rances-residence1.webp");
  overflow: hidden;
